...
@WebServlet("/store")
public class StoreUserInfoController extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    try {
	        ...
	        String sql="insert into userinfo(phonenumber,correct,gift) values('" + phoneNumber +"'," + correct + ",'" + gift + "')";   //SQL语句
